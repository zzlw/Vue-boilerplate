...
(function ($) {
  ...
  $.fn.barrager = function (barrage) {
    ...
    div_barrager.css("bottom", bottom);
    let div_barrager_box = $("<div class='barrage_box cl'></div>").appendTo(div_barrager);
    if (barrage.img) {

      div_barrager_box.append("<div class='portrait z'   ></div>");
      var img = $("<img src='' width='100%' height='100%' >").appendTo(id + " .barrage_box .portrait");
    ...
    let title = $("<div><div class='barrager_title'>" + barrage.title +"</div><div  class='barrager_text'>" + barrage.info +"</div></div>");
    ...
    $(id).animate({ right: rem(this_width) }, barrage.speed * 1000, function () {
